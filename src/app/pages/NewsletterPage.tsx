...
const benefits = [
  { icon: Mail, title: "Two briefings each week", text: "The latest news, opinion and products affecting the data centre industry." },
  { icon: BookOpen, title: "The magazine in your inbox", text: "Direct access to new digital editions of Data Centre Review." },
  { icon: CalendarDays, title: "Invitations to DCR events", text: "Hear first about exclusive briefings, webinars and industry events." },
];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="bg-[#f7f8fc]">
        <section className="bg-[var(--navy-deep)] text-white"><div className="mx-auto max-w-[1440px] px-4 py-16 text-center md:px-8 md:py-24"><h1 className="text-[48px] leading-[0.96] md:text-[72px]" style={{ fontWeight: 750 }}>The DCR briefing</h1><p className="mx-auto mt-6 max-w-[720px] text-[17px] leading-[1.7] text-white/75 md:text-[20px]">The developments that matter across data centres, energy and critical infrastructure—delivered directly to you.</p></div></section>
